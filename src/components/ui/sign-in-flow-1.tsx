    ...
    <header className={cn(
      ...
      <div className="flex items-center justify-between w-full gap-x-6 sm:gap-x-8">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-white tracking-tight">MCP Scanner</span>
        </Link>
        ...
        <div className="hidden sm:flex items-center gap-2 sm:gap-3">
          <Link href="/sign-up" className="relative group">
            ...
            <span className="relative z-10 px-4 py-2 sm:px-3 text-xs sm:text-sm font-semibold text-black bg-gradient-to-br from-gray-100 to-gray-300 rounded-full hover:from-gray-200 hover:to-gray-400 transition-all duration-200 inline-block">
              Sign Up
            </span>
          </Link>
        </div>
                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <p className="text-[1.8rem] text-white/70 font-light">Sign in to MCP Scanner</p>
                    </div>
                      ...
                      <form onSubmit={handleEmailSubmit}>
                        <div className="relative">
                          <input
                            ...
                            className="w-full backdrop-blur-[1px] text-white border border-white/10 rounded-full py-3 px-4 bg-transparent focus:outline-none focus:border-white/30 text-center"
                            required
                          />
                          <button
                            type="submit"
                    ...
                    <p className="text-xs text-white/40 pt-10">
                      ...
                      <Link href="#" className="underline text-white/40 hover:text-white/60 transition-colors">Terms</Link> and{" "}
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <p className="text-[1.25rem] text-white/50 font-light">Welcome to MCP Scanner</p>
                    </div>
                    ...
                    <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.5, delay: 0.5 }} className="py-10">
                      <div className="mx-auto w-16 h-16 rounded-full bg-gradient-to-br from-white to-white/70 flex items-center justify-center">
                        <svg className="h-8 w-8 text-black" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1 }}>
                      <Link href="/dashboard" className="block w-full rounded-full bg-white text-black font-medium py-3 hover:bg-white/90 transition-colors text-center">
